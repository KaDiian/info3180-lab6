...
const Home = {
 ...
 const NewsList = {
  ...
  <ul class="card-lay rounded ">
    <li v-for="article in articles" class="card " style="width: 18rem;">
      <span class='pt-2 bg-success rounded'></span>
        <h5 class="font-weight-bold pt-1 card-title text-left">{{ article.title }}</h5>
